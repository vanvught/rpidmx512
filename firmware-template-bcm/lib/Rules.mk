...
$(BUILD)$1/%.o: $1/%.cpp
	$(CPP) $(COPS) -std=c++20 -pedantic -fno-exceptions -fno-unwind-tables -fno-rtti -fno-threadsafe-statics -c $$< -o $$@
...
$(BUILD7)$1/%.o: $1/%.cpp
	$(CPP) $(COPS7) -std=c++20 -pedantic -fno-exceptions -fno-unwind-tables -fno-rtti -fno-threadsafe-statics -c $$< -o $$@	
...
$(TARGET): Makefile.BCM $(OBJECTS)
	$(AR) -r $(TARGET) $(OBJECTS)
	$(PREFIX)objdump -D $(TARGET) | $(PREFIX)c++filt > lib/$(LIST)
	
# ARM v7		

$(TARGET7): Makefile.BCM $(OBJECTS7)
