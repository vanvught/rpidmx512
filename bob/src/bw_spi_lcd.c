...
void bw_spi_lcd_text(char *text, uint8_t length) {
	static char data[22];
...
void bw_spi_lcd_text_line_1(char *text, uint8_t length) {
...
void bw_spi_lcd_text_line_2(char *text, uint8_t length) {
...
void bw_spi_lcd_text_line_3(char *text, uint8_t length) {
...
void bw_spi_lcd_text_line_4(char *text, uint8_t length) {
...
void bw_spi_lcd_read_id(void) {
	char buf[BW_LCD_ID_STRING_LENGTH + 1] = { spi_lcd_slave_address, 0x01 };
	lcd_spi_setup();
