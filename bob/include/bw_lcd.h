...
#define lcd__startup_message_line_1		bw_spi_lcd__startup_message_line_1
#define lcd__startup_message_line_2		bw_spi_lcd__startup_message_line_2
#define lcd__startup_message_line_3		bw_spi_lcd__startup_message_line_3
#define lcd__startup_message_line_4		bw_spi_lcd__startup_message_line_4
